...
<nav
    ...
    <ul class="flex space-x-8 relative">
        ...
        <li class="relative">
            <a class=" border-b-2 border-tosca-500 text-tosca py-2" href=""
                class="text-gray-400 hover:text-tosca py-2">Home</a>

        </li>
        @auth
            <li class="relative">
                <a href="{{ route('logout') }}" class="text-gray-400 hover:text-tosca py-2">Logout</a>
            </li>
